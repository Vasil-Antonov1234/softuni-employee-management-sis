            ...
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        <h2>{isEditUser ? "Edit" : "Add"} User</h2>
                    ...
                    <form onSubmit={(event) => onSubmit(event, isEditUser, userId)}>
                        ...
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit">{isEditUser? "Edit" : "Create"}</button>
